package br.com.maikon.orderserviceapi.controllers.exceptions;
...
public class ControllerExceptionHandler {
    ...
    ResponseEntity<Map> handleGenericFeignException(final GenericFeignException ex) {//Captura as exceptions do feign para retornar o erro
